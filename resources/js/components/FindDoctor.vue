<template>
	<div>
		<div class="card">
			<div class="card-header">日時を選択してください</div>
			<div class="card-body">
		...
		<div class="card mt-5">
			<div class="card-header">施工管理</div>
			<div class="card-body">
					...
					<thead>
						...
						<tbody>
							...
							<tr v-for="(d,index) in doctors" v-if="!loading">
								...
								<td>
									<a :href="'/new-appointment/'+ d.user_id+'/'+d.date "><button class="btn btn-success">予約する</button></a>
								</td>
							</tr>
							<td v-if="doctors.length==0">ご予約がいっぱいです。しばらくお待ちください {{this.time}}</td>
						</tbody>
